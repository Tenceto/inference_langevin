...
from edp_gnn.evaluation.stats import eval_torch_batch, adjs_to_graphs, eval_graph_list
from edp_gnn.utils.arg_helper import mkdir, set_seed_and_logger, load_data, graphs_to_tensor, load_model, parse_arguments, \
    get_config
from edp_gnn.utils.graph_utils import add_gaussian_noise
from edp_gnn.utils.loading_utils import get_mc_sampler, eval_sample_batch, prepare_test_model
from edp_gnn.utils.visual_utils import plot_graphs_list
...
def sample_main(ori_config, args):
    ...
    _, gen_graph_list = run_sample(target_graph_list=test_graph_list,
                                   ...
                                   eps=best_config['eps'],
                                   validation=False,
                                   eval_len=config.sample.num_samples)
    print(best_config)
