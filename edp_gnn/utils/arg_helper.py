...
from edp_gnn.utils.data_generators import load_dataset
from edp_gnn.utils.graph_utils import pad_adjs
...
def load_data(config, get_graph_list=False):
    graph_list, node_feature_set = load_dataset(data_dir='edp_gnn/data', file_name=config.dataset.name)
